                            ...
                            <ul className="sidebar_nav">
                                ...
                                <li>
                                    <button type="button" className="link" aria-controls="community_dropdown" data-collapse-toggle="community_dropdown">
                                        ...
                                        <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">Community</span>
                                    ...
                                    <ul id="community_dropdown" className="sidebar_dropdown hidden">
                                        ...
                                        <li>
                                            <a href="https://havenexbackend.bkolpo.com/community/2/edit" className="dropdown_link">Profile</a>
                                        </li>
                                        <li>
                                            <a href="https://havenexbackend.bkolpo.com/blocks" className="dropdown_link">Blocks</a>
                                        </li>
                                        <li>
                                            <a href="https://havenexbackend.bkolpo.com/units" className="dropdown_link">Units</a>
                                        </li>
                                        <li>
                                            <a href="https://havenexbackend.bkolpo.com/units/create" className="dropdown_link">Add Unit</a>
                                        </li>
                                ...
                                <li>
                                    <button type="button" className="link" aria-controls="directory_dropdown" data-collapse-toggle="directory_dropdown">
                                        ...
                                        <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">Directory</span>
                                        <svg sidebar-toggle-item="" className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path>
                                        </svg>
                                    </button>
                                    <ul id="directory_dropdown" className="sidebar_dropdown hidden">
                                        <li>
                                            <a href="https://havenexbackend.bkolpo.com/members" className="dropdown_link">Registered Users</a>
                                        </li>
                                        <li>
                                            <a href="https://havenexbackend.bkolpo.com/maintenance_staff" className="dropdown_link">Maintenance Staff</a>
                                        </li>
                                        <li>
                                            <a href="/directory/administrators.php" className="dropdown_link">Administrators</a>
                                        </li>
                                        <li>
                                            <a href="https://havenexbackend.bkolpo.com/vendors" className="dropdown_link">Vendors</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <button type="button" className="link" aria-controls="amenities_dropdown" data-collapse-toggle="amenities_dropdown">
                                        <svg className="icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"></path>
                                        </svg>
                                        <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">Amenities</span>
                                        <svg sidebar-toggle-item="" className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path>
                                        </svg>
                                    </button>
                                    <ul id="amenities_dropdown" className="sidebar_dropdown hidden">
                                        <li>
                                            <a href="https://havenexbackend.bkolpo.com/amenity-bookings" className="dropdown_link">Booking</a>
                                        </li>
                                        <li>
                                            <a href="https://havenexbackend.bkolpo.com/amenities" className="dropdown_link">Amenities</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <button type="button" className="link" aria-controls="helpdesk_dropdown" data-collapse-toggle="helpdesk_dropdown">
                                        ...
                                        <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">Helpdesk</span>
                                        <svg sidebar-toggle-item="" className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path>
                                        </svg>
                                    </button>
                                ...
                                <li>
                                    <button type="button" className="link" aria-controls="setting_dropdown" data-collapse-toggle="setting_dropdown">
                                        ...
                                        <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">Announcements</span>
                                        <svg sidebar-toggle-item="" className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path>
                                        </svg>
                                    </button>
