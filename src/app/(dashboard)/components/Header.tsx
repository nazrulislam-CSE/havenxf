...
export default function Header() {
    return(
        ...
        <link rel="preload" as="style" href="https://havenexbackend.bkolpo.com/build/assets/app-Cuvvq_UU.css" />
        <link rel="preload" as="style" href="https://havenexbackend.bkolpo.com/build/assets/app-CksuuEqD.css" />
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center justify-start">
                                <button id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar"
                                    className="p-2 text-gray-600 rounded cursor-pointer lg:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                                ...
                                <div className="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                                    id="apps-dropdown">
                                    <div
                                        className="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                        Apps
                                    ...
                                    <div className="grid grid-cols-3 gap-4 p-4">
                                        <a href="#"
                                            ...
                                            <svg className="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400" fill="currentColor"
                                                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd"
                                        ...
                                        <a href="#"
                                            className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                            <svg className="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400" fill="none"
                                    ...
                                    <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                                        ...
                                        <div className="px-4 py-3" role="none">
                                            ...
                                            <p className="text-sm font-medium text-gray-900 truncate dark:text-gray-300" role="none">
                                                <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="9ffafef7e7faf1dff8f2fef6f3b1fcf0f2">[email&#160;protected]</a>
                                            </p>
                                        </div>
                                        <ul className="py-1" role="none">
                                            <li>

                                                <a href="https://havenexbackend.bkolpo.com/profile"
