...
export default function CreateStaff() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Simulate saving
        setTimeout(() => {
            router.push('/setting/staff'); // Navigate back to the staff list
        }, 500);
    };
        ...
        <main className="app_container">
            <div className="px-4 pt-6 max-w-3xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800">Add New Staff Type</h2>
                    <button
                        onClick={() => router.push('/setting/staff')}
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-md shadow-lg w-full">
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700 mb-1">Add New Staff Type</label>
                        <input
                            type="text"
                            name="name"
                            value={formData.name}
