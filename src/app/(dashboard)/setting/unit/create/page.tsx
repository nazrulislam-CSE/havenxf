...
export default function CreateUnit() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Simulate saving
        setTimeout(() => {
            router.push('/setting/unit'); // Navigate back to the unit list
        }, 500);
    };
        ...
        <main className="app_container">
            <div className="px-4 pt-6 max-w-3xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800">Add Unit Type</h2>
                    <button
                        onClick={() => router.push('/setting/unit')}
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-md shadow-lg w-full">
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700 mb-1">Unit Type Name</label>
                        <input
                            type="text"
                            name="name"
                            value={formData.name}
